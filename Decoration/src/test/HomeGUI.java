...
public class HomeGUI extends JFrame {
	...
	/*private JLabel lblName = new JLabel("Manag'Apart");*/ // TODO Je pense qu'on devrait voter pour le nom. Proposez vos nom, y a pas de soucis. Mais quand j'ai demand�, personne n'a rien dit ^^'
